...
Root JSON `kbbi_v6` berisi array entri. Envelope ini membuat file mengikuti
standar satu root key yang dipakai seluruh repositori.
...
- SHA-256 snapshot: dihitung ulang pada manifest [`dataset_manifest__JSON.json`](../dataset_manifest__JSON.json).
